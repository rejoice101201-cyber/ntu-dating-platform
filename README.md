...
- **效能監控**：http://localhost:3000/api/performance
...
#### 前端效能監控儀表板
- 點擊右下角 "📊 Performance" 按鈕開啟儀表板
- 實時查看請求統計、響應時間、快取命中率等指標
- 支援自動刷新和手動重置功能

#### 後端效能監控
- 訪問 `http://localhost:3000/api/performance` 查看後端效能指標
- 包含請求計數、響應時間、錯誤統計、記憶體使用等
- 支援重置效能指標功能

#### 效能優化特性
- **智能快取**：自動快取 API 響應，減少重複請求
- **防抖動機制**：搜尋請求防抖動，提升用戶體驗
- **請求優化**：合併和取消不必要的請求
- **記憶體管理**：自動清理過期快取
