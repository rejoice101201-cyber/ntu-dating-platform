...
import { performanceMonitor, errorTracker, getPerformanceMetrics, resetPerformanceMetrics } from './middleware/performance';
...
app.use(cors({
  origin: [
    'http://localhost:5173',  // Primary frontend port (Vite default)
    'http://127.0.0.1:5173',
